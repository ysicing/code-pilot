...
```bash
/kiro-status                # 查看所有功能
/kiro-switch payment        # 切换到支付模块
/kiro design payment        # 设计支付架构
/kiro-switch user-auth      # 切换回用户认证
```
...
**Q: 工作流程中断了怎么办？**  
A: 使用 `/kiro-continue` 或 `/kiro-status` 查看状态
